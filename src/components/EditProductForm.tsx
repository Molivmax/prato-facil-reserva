  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-medium text-white">Editar Produto</h3>
        {onCancel && (
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div>
            <FormLabel className="text-white">Imagem do Produto</FormLabel>
            <div className="mt-2">
              <Input
                type="file"
                accept="image/*"
          ...
          <div className="flex gap-2">
            <Button 
              type="submit" 
              disabled={isLoading}
              className="flex-1 bg-blink-primary hover:bg-blink-primary/90 text-black"
            >
